...
//    		TIM_Cmd(TIM6,DISABLE);
    		...
    		avg = round(avg/10.);
			sprintf(uartBuffer, "Geschwindigkeit %04.3f cm/s. Average %04.3f cm/s\r\n", (float) 17.3 / (48. * elapsedtime[run_counter]/10000.),(float) 17.3 / (48. * (avg/10000.)));
